      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://aman-menda.notion.site/Politique-de-confidentialit-f69588453a9942adabf140dfce46f573?pvs=4" className="text-gray-400 hover:text-white">Politique de Confidentialité</a></li>
              <li><a href="https://aman-menda.notion.site/Demande-de-suppression-de-compte-b888b3dc468340c2b455f9cce6f95a01?pvs=4" className="text-gray-400 hover:text-white">Conditions d'Utilisation</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/roadmaster.official" className="text-gray-400 hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="#http://linkedin.com/company/roadmaster-team" className="text-gray-400 hover:text-white">
